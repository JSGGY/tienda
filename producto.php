...
<html>
    ...
    <body>
        ...
        <h2 style="display: inline;"><?php echo isset($_COOKIE['preferenciaIdioma']) && $_COOKIE['preferenciaIdioma'] === 'en' ? 'ID: ' : 'ID: '; ?></h2>
        <span style="font-size: 1.3em; font-weight: normal;"> <?php echo htmlspecialchars($_SESSION['productoSeleccionado']["id"]); ?> </span><br><br>
        ...
        <a href="carroCompra.php"><button><?php echo isset($_COOKIE['preferenciaIdioma']) && $_COOKIE['preferenciaIdioma'] === 'en' ? 'Go to shopping cart' : 'Ir al carrito de compras'; ?></button></a><br><br>
        
        <a href="panel.php"><?php echo isset($_COOKIE['preferenciaIdioma']) && $_COOKIE['preferenciaIdioma'] === 'en' ? 'Back to Panel' : 'Volver al Panel'; ?></a><br>
